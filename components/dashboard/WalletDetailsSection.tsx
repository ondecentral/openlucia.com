    ...
    <>
      <section className="p-3">
        ...
        <div className="border border-gray-200 rounded-lg p-3">
          <div className="flex items-center justify-between align-flex-start">
          ...
          <ul className="space-y-2 text-sm">
            {/* <li className="flex justify-between items-center gap-1.5">
              <span className="text-gray-500">Wallet Rank</span>
            ...
            <li className="flex justify-between items-center gap-1.5">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <a
                  href={getExplorerUrlForAddress(currentWallet?.address || visitor.wallet_address)}
                  target="_blank"
            ...
            <li className="flex justify-between items-center gap-1.5">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <button
                  onClick={() => onCopyToClipboard(currentWallet?.ens_domain || visitor.ens_domain)}
                  className="text-gray-400 hover:text-gray-600 transition-colors"
                  title="Copy domain"
                >
                  <Copy className="w-4 h-4" />
