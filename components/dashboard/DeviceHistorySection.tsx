...
const DeviceHistorySection: React.FC<DeviceHistorySectionProps> = ({
  visitor,
  ipIndex,
  onNavigateIP,
}) => {
    ...
    <>
      <section className="p-3">
        <div className="flex items-center justify-center gap-3 mb-2">
          ...
          <h2 className="text-xs text-gray-400 font-semibold tracking-wider">DEVICE HISTORY</h2>
          <button
        ...
        <div className="border border-gray-200 rounded-lg">
          ...
          <ul className="divide-y divide-gray-200 text-sm">
            ...
            <li className="p-2.5 flex justify-between items-center">
              ...
              <span>{visitor.ip_addresses[ipIndex]?.location || visitor.location}</span>
            </li>
            <li className="p-2.5 flex justify-between items-center">
              <strong className="font-medium text-gray-600">IP Address</strong>
              <span>{visitor.ip_addresses[ipIndex]?.ip || visitor.ip_address}</span>
            </li>
            <li className="p-2.5 flex justify-between items-center">
