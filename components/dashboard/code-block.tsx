...
const CodeBlock = ({
  ...
  if (language === "typescript") {
    ...
    processedCode = processedCode.replace(
      /\.<span class="hljs-title">([^<]+)<\/span>/g,
      '.<span style="color: rgb(253 186 116)">$1</span>',
    );
  ...
  return (
    <div className="relative overflow-hidden rounded-lg bg-black">
      ...
      <button
        ...
        className="absolute right-3 top-3 z-10 rounded-md border border-gray-600 bg-gray-800 px-3 py-1.5 text-xs font-medium text-gray-300 shadow-lg transition-all duration-200 hover:border-gray-500 hover:bg-gray-700 hover:text-white"
      >
        {copied ? (
