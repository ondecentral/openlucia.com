...
# or
$ yarn add lucia-sdk`} language="bash" />
        </div>
        
        {/* INITIALIZE EXAMPLE */}
        <div className="mb-6">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">Initialize the SDK in your application:</h3>
          <CodeBlock code={`import LuciaSDK from 'lucia-sdk';
...
LuciaSDK.init({
  apiKey: import.meta.env.VITE_CLICKINSIGHTS_API_KEY
        ...
        <div className="mb-6">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">Wallet Login Tracking</h3>
          ...
          <CodeBlock code={`interface WalletLoginParams {
